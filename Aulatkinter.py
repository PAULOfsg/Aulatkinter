...
label.grid(row=0, column=0, padx=12, pady=12)  # Espaçamento externo

# Entry nome:
entry = tk.Entry(janela, width=25)
entry.grid(row=1, column=0, padx=12, pady=12)  # Espaçamento externo

#Label idade
label = tk.Label(janela, text="Qual sua idade?", **estilo_label)
label.grid(row=0, column=0, padx=12, pady=12)  # Espaçamento externo
...
label_2.grid(row=2, column=0, padx=12, pady=12)  # Espaçamento externo
...
label_3.grid(row=4, column=0, padx=12, pady=10)  # Espaçamento externo
